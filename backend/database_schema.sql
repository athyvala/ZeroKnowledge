...
-- Session shares table with expiration support
CREATE TABLE IF NOT EXISTS session_shares (
  ...
  expiration_minutes INTEGER DEFAULT 60, -- Store original expiration duration
...
-- NEW: Access requests table (modified to work with friends and expiration)
CREATE TABLE IF NOT EXISTS access_requests (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  responded_at TIMESTAMP,
  requested_expiration_minutes INTEGER DEFAULT 60, -- Requested expiration time
  approved_expiration_minutes INTEGER, -- Actual approved expiration time
  expires_at TIMESTAMP, -- When the approved access expires
